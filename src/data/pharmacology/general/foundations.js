  ...
  },
{
    ...
    keyPoints:['Generic names improve clarity across manufacturers','One active ingredient may have multiple brand names','Strength and dosage form are separate from the drug name'],rapid:['Chemical → generic → brand','Drug name ≠ dosage form'],quiz:[]
  }
];
